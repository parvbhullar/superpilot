...
from superpilot.examples.abilities.clipdrop import ClipDropGenerator
...
ALLOWED_ABILITY = {ClipDropGenerator.name(): ClipDropGenerator.default_configuration}


class ClipDropImageExecutor(BaseExecutor):
