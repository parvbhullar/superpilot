...
class StepStrategyConfiguration(SystemConfiguration):
...
class StepStrategy(PromptStrategy):
    ...
    default_configuration = StepStrategyConfiguration(
    ...
    def build_prompt(
        ...
        # TODO once we start passing context in task action history we will remove it from here.
        context = template_kwargs.get("context", "")
