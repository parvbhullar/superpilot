...
class InitialPlan(PromptStrategy):
    ...
    DEFAULT_SYSTEM_PROMPT_TEMPLATE = (
        ...
        "break down those goals into a set of tasks that the pilot can accomplish to achieve those goals. "
    ...
    DEFAULT_USER_PROMPT_TEMPLATE = (
        "You are {pilot_name}, {pilot_role}\n" "Your goals are:\n" "{pilot_goals}"
    )

    DEFAULT_CREATE_PLAN_FUNCTION = {
        "name": "create_initial_pilot_plan",
