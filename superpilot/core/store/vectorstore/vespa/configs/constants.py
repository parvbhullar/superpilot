...
UNPOD_METADATA_FILENAME = ".unpod_metadata.json"

# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of Unpod.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use Unpod as a search engine."
)


# API Keys
UNPOD_API_KEY_PREFIX = "API_KEY__"
UNPOD_API_KEY_DUMMY_EMAIL_DOMAIN = "unpodapikey.ai"
UNNAMED_KEY_PLACEHOLDER = "Unnamed"

#Index Hub Keys
UNPOD_HUB_ID = "hub_id"
UNPOD_KN_TOKEN = "kn_token"


class DocumentSource(str, Enum):
    # Special case, document passed in via Unpod APIs without specifying a source type
