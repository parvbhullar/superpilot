...
async def entrypoint(ctx: JobContext):
    ...
    try:
        # Attempt to create SIP participant
        ...
        logger.info(f"SIP participant created successfully: {response}")
    ...
    logger.info(f"Participant joined the room: {participant.identity}")

    # Running multimodal agent
    ...
    while perf_counter() - start_time < 30:
        ...
        if call_status == "active":
            ...
            logger.error("Call rejected.")
            break
        elif participant.disconnect_reason:
            logger.error(f"Disconnect reason: {participant.disconnect_reason}")
            break
