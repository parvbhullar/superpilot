from super_store.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT
from super_store.prompts.direct_qa_prompts import PARAMATERIZED_PROMPT_WITHOUT_CONTEXT
