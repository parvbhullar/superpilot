...
gstr1_delete_fields = [
    {
        ...
        "mandate": True,
        "checks": [
            {"method": "validate_regex", "kwargs": {"field_name": "supplier_gstin"}}
        ],
    },
    {
    ...
    },
    {
        ...
        "mandate": True,
        "checks": [
            {"method": "valid_in", "kwargs": {"list_to_be_checked": ["add", "d"]}}
        ],
    },
]
gstr2_delete_fields = [
...
gstr1_invoice_status_c__mandate_fields = [
    "supplier_gstin",
    "document_number",
    "document_date",
    "supply_type",
...
gstr1_fields = [
    ...
    },
    {
        ...
        "mandate": False,
        "checks": [
            {"method": "valid_in", "kwargs": {"list_to_be_checked": valid_port_code}}
        ],
    },
    {
        "name": "customer_name",
        "mandate": False,
        "checks": [
            {"method": "validate_regex", "kwargs": {"field_name": "alpha_check"}}
        ],
    },
    {
        "name": "supply_type",
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {
                    "list_to_be_checked": ["nor", "emp", "nrt", "ngt"],
                    "error_message": ["Normal", "Exempted", "Nil-Rated", "Non-Gst"],
                },
            }
        ],
    },
    ...
    # },
    {
        ...
        "mandate": False,
        "checks": [
            {"method": "validate_invoice_date", "kwargs": {}},
    ...
    },
    {
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {"list_to_be_checked": ["y", "Y", "N", "n"]},
            }
        ],
    },
    {
    ...
    },
    {
        ...
        "mandate": True,
        "checks": [
            {"method": "valid_in", "kwargs": {"list_to_be_checked": valid_state_code}}
        ],
    },
    {
    ...
    },
    {
        ...
        "mandate": True,
        "checks": [
            {"method": "valid_in", "kwargs": {"list_to_be_checked": ["add", "d", "c"]}}
        ],
    },
    {
        ...
        "checks": [
            {
                ...
                "kwargs": {"field_name": "total_invoice_value"},
            }
        ],
    },
    {
    ...
    },
    {
        ...
        "checks": [
            {
                "method": "validate_dependency_check",
                "kwargs": {
                    "field_to_be_present": [
                            ...
                            "checks": [
                                {
                                    "method": "valid_in",
                                    "kwargs": {
                                        "list_to_be_checked": ["wopay", "wpay", "exp"]
                                    },
                                }
                            ],
                        }
                    ],
                    "field_name": "invoice_category",
                    "field_value": "exp",
                },
            }
        ],
...
gstr1_voucher_items_field = [
    {
        ...
        "mandate": False,
        "checks": [
            {"method": "check_len", "kwargs": {"min_len": 4, "max_len": 8}},
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {
                    "list_to_be_checked": ["n", "N", "is", "IS", "IN", "in", "cd", "CD"]
                },
            }
        ],
    },
                            ...
                            "checks": [
                                {
                                    "method": "valid_in",
                                    "kwargs": {
                                        "list_to_be_checked": valid_gst_rate_list
                                    },
                                }
                            ],
                            "mandatory": False,
...
inter_mandate_two = [
    {
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {"list_to_be_checked": ["0", "", "0.0", None]},
            }
        ],
    }
]
...
gstr1_item = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        "hsn_code": openapi.Parameter(
            "hsn_code",
            openapi.IN_BODY,
        ...
        "unit_of_product": openapi.Parameter(
            "unit_of_product",
            openapi.IN_BODY,
            type=openapi.TYPE_STRING,
            description="string",
        ...
        "taxable_value": openapi.Parameter(
            "taxable_value",
            openapi.IN_BODY,
            type=openapi.FORMAT_DOUBLE,
            description="It accepts decimal value accurate to two decimal places",
        ...
        "item_description": openapi.Parameter(
            "item_description",
            openapi.IN_BODY,
            type=openapi.TYPE_STRING,
            description="string",
...
gstr_1_data = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        "document_number": openapi.Parameter(
            "document_number",
            openapi.IN_BODY,
        ...
        "document_date": openapi.Parameter(
            "document_date",
            openapi.IN_BODY,
        ...
        "original_document_number": openapi.Parameter(
        ...
        "original_document_date": openapi.Parameter(
        ...
        "ref_document_number": openapi.Parameter(
            "ref_document_number",
            openapi.IN_BODY,
        ...
        "ref_document_date": openapi.Parameter(
            "ref_document_date",
            openapi.IN_BODY,
        ...
        "invoice_status": openapi.Parameter(
            "invoice_status",
            openapi.IN_BODY,
        ...
        "invoice_category": openapi.Parameter(
            "invoice_category",
            openapi.IN_BODY,
        ...
        "invoice_type": openapi.Parameter(
            "invoice_type",
            openapi.IN_BODY,
        ...
        "taxtable_value": openapi.Parameter(
            "taxable_value",
            openapi.IN_BODY,
        ...
        "shipping_bill_number": openapi.Parameter(
        ...
        "shipping_bill_date": openapi.Parameter(
            "shipping_bill_date",
            openapi.IN_BODY,
        ...
        "reason": openapi.Parameter(
            "reason",
            openapi.IN_BODY,
            description="Reason for Amending the invoice",
            type=openapi.TYPE_STRING,
            required=False,
        ),
        "port_code": openapi.Parameter(
            "port_code",
            openapi.IN_BODY,
        ...
        "gstr1_return_period": openapi.Parameter(
            "gstr1_return_period",
            openapi.IN_BODY,
        ...
        "gstr3b_return_period": openapi.Parameter(
        ...
        "reverse_charge": openapi.Parameter(
            "reverse_charge",
            openapi.IN_BODY,
        ...
        "place_of_supply": openapi.Parameter(
            "place_of_supply",
            openapi.IN_BODY,
        ...
        "supplier_gstin": openapi.Parameter(
            "supplier_gstin",
            openapi.IN_BODY,
        ...
        "customer_name": openapi.Parameter(
            "customer_name",
            openapi.IN_BODY,
...
data = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        "purchaseData": openapi.Parameter(
            "purchaseData",
            openapi.IN_BODY,
...
preparing_response_format["error"] = openapi.Schema(
    type=openapi.TYPE_OBJECT, properties={}
)
preparing_response_format["itemList"] = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        **gstr1_item.properties,
        ...
        properties={
            "purchaseData": openapi.Parameter(
                ...
                items=openapi.Schema(
                    type=openapi.TYPE_OBJECT, properties=preparing_response_format
                ),
                type=openapi.TYPE_ARRAY,
            )
        },
...
gstr2_fields = [
    {
        ...
        "checks": [
            {
                "method": "check_for_supplier_gstin",
                "kwargs": {},
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {
                    "list_to_be_checked": ["y", "yes", "n", "ip", "is", "cp", "no"]
                },
            }
        ],
    },
    ...
    },
    {
        ...
        "checks": [
            {
                "method": "check_len",
                "kwargs": {"min_len": 0, "max_len": 16},
                "message": "Invoice no/Note no/Bill of entry no. should not exceed 16 characters",
            },
    ...
    },
    {
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {"list_to_be_checked": ["y", "Y", "N", "n", "P", "p"]},
            }
        ],
    },
    {
    ...
    },
    {
        ...
        "checks": [
            ...
            {
                "method": "past_return_period_check",
                "kwargs": {},
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {
                    "list_to_be_checked": ["n", "N", "is", "IS", "IN", "in", "cp", "CP"]
                },
            }
        ],
    },
...
error_constant_mandatory = {
    "document_number": "GDM01",
    "document_date": "GDM02",
    "original_document_number": "GOM01",
    "original_document_date": "GOM02",
    "ref_document_number": "GRM01",
    "ref_document_date": "GRM02",
    "original_month": "GOV03",
    "supply_type": "GSM01",
    "invoice_status": "GIM01",
    "invoice_category": "GIM02",
    "invoice_type": "GIM03",
    "total_invoice_value": "GTM01",
    "total_taxable_value": "GTM02",
    "txpd_taxtable_value": "GTM03",
    "shipping_bill_number": "GSM02",
    "shipping_bill_date": "GSM03",
    "reason": "GRM03",
    "port_code": "GPM01",
    "location": "GLM01",
    "gstr1_return_period": "GGM01",
    "gstr3b_return_period": "GGM02",
    "reverse_charge": "GRM04",
    "issez": "GIM04",
    "isamended": "GIM04",
    "amended_pos": "GAM05",
    "amended_period": "GAM06",
    "place_of_supply": "GPM02",
    "supplier_gstin": "GSM04",
    "buyer_gstin": "GBM01",
    "customer_name": "GCM01",
    "itemList": "GIM05",
    "igst_amount": "GIMI01",
    ...
    "hsn_code": "GIMH01",
    "product_name": "GIPH01",
    "item_description": "GIMI02",
    "quantity": "GIMQ01",
    "cess_amount": "GIMC02",
    "gst_rate": "GIMG01",
    "unit_of_product": "GIMU01",
    "itc_elgibity": "GIM06",
    "gstr2_return_period": "GGM03",
    "inv_itc_elgibity": "GIM07",
    "sale_through_ecommerce_operator": "GGM04",
    "invoice/note number": "GDM01",
    "invoice/note date": "GDM02",
}

error_constant_valid = {
    "document_number": "GDV01",
    "document_date": "GDV02",
    "original_document_number": "GOV01",
    "original_document_date": "GOV02",
    "original_month": "GOV03",
    "ref_document_number": "GRV01",
    "ref_document_date": "GRV02",
    "supply_type": "GSV01",
    "invoice_status": "GIV01",
    "invoice_category": "GIV02",
    "invoice_type": "GIV03",
    "total_invoice_value": "GTV01",
    "total_taxable_value": "GTV02",
    "txpd_taxtable_value": "GTV03",
    "shipping_bill_number": "GSV02",
    "shipping_bill_date": "GSV03",
    "reason": "GRV03",
    "port_code": "GPV01",
    "location": "GLV01",
    "gstr1_return_period": "GGV01",
    "gstr3b_return_period": "GGV02",
    "reverse_charge": "GRV04",
    "issez": "GRV04",
    "isamended": "GIV04",
    "amended_pos": "GAV05",
    "amended_period": "GAV06",
    "place_of_supply": "GPV02",
    "supplier_gstin": "GSV04",
    "buyer_gstin": "GBV01",
    "customer_name": "GCV01",
    "itemList": "GIV05",
    "igst_amount": "GIVI01",
    ...
    "hsn_code": "GIVH01",
    "product_name": "GIVP01",
    "item_description": "GIVI02",
    "quantity": "GIVQ01",
    "cess_amount": "GIVC02",
    "gst_rate": "GIVG01",
    "unit_of_product": "GIVU01",
    "itc_elgibity": "GIV06",
    "gstr2_return_period": "GGV03",
    "inv_itc_elgibity": "GIV07",
    "validate_gstin_for_buy_sup": "GSV05",
    "invoice_date_return_period": "GGV04",
    "3b_auto_fill_period": "GGV05",
    "sale_through_ecommerce_operator": "GGV06",
    "etin": "GGV07",
    "ERP_document_number": "GDV03",
    "ERP_document_date": "GDV04",
    "invoice/note number": "GDM01",
    "invoice/note date": "GDM02",
}
...
gstr2_validationoff_fields = [
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {
                    "list_to_be_checked": ["y", "Y", "N", "n", "P", "p"],
                    "default_value": "",
                },
            }
        ],
    },
    {
        ...
        "checks": [
            {
                "method": "check_data_types",
                "kwargs": {"data_type": "float", "default_value": 0.0},
            }
        ],
    },
    {
    ...
    },
    {
        ...
        "checks": [
            {
                "method": "valid_in",
                "kwargs": {"list_to_be_checked": ["add", "d"], "default_value": "add"},
            }
        ],
    },
    {
...
gstr1_import_settings_fields = {
    ...
    "product_name": {"name": "product_name", "mandate": False, "checks": []},
}
