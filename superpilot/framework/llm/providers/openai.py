...
class OpenAIFunctionSpec:
    """Represents a "function" in OpenAI, which is mapped to a Command in Superpilot"""
...
def get_openai_command_specs(
    ...
    """Get OpenAI-consumable function specs for the pilot's available commands.
...
def count_openai_functions_tokens(
    ...
    """
    from superpilot.framework.llm.utils import count_string_tokens
