...
from superpilot.core.configuration.schema import Configurable, SystemSettings
from superpilot.framework.llm.providers.openai import OPEN_AI_CHAT_MODELS
from superpilot.framework.plugins.plugins_config import PluginsConfig
...
class Config(SystemSettings, arbitrary_types_allowed=True):
    ...
    smart_llm_model: str = "gpt-4-0314"
    temperature: float = 0
    ...
    memory_index: str = "superpilot-memory"
    ...
    user_pilot: str = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36"
...
class ConfigBuilder(Configurable[Config]):
    ...
    def load_env(cls, workdir):
        ...
        config_dict = {
            ...
            "fast_llm_model": os.getenv("FAST_LLM", os.getenv("FAST_LLM_MODEL")),
            "smart_llm_model": os.getenv("SMART_LLM", os.getenv("SMART_LLM_MODEL")),
            ...
            "user_pilot": os.getenv("USER_AGENT"),
